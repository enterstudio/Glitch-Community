...
module.exports =
  ...
  projects: -> [
    ...
    ,
      ...
      projectName: 'browserify-middleware'
    ...
    ,
      ...
      projectName: 'trello-shopping-list'
    ...
    ,
      ...
      projectName: 'font-awesome-export'
    ...
    ,
      ...
      projectName: 'beginner-javascript'
      description: "Learn the basics of HTML, JavaScript, triggering actions and using jQuery"
      categoryIds: [4]  
    ,
      name: 'Assets.js'
      projectId: 'cb02d9ae-61ed-4053-b465-d6e2e9656ac3'
      projectName: 'assets-lib'
    ...
    ,
      ...
      projectName: 'intermediate-javascript'
    ...
    ,  
      ...
      projectName: 'circles-bouncing-off-lines'
    ...
    ,
      ...
      projectName: 'firebase-quickstart'
    ...
    ,
      ...
      projectName: 'salesforce-quickstart'
      projectAvatarNeedsBackground: true
    ...
    ,
      ...
      projectName: 'multi-ifttt-triggers'
    ...
    ,
      ...
      projectName: 'conditional-ifttt-triggers'
    ...
    ,
      ...
      projectName: 'coffee-script-base'
    ...
    ,
      ...
      projectName: 'livechat-sample-agent-app'
